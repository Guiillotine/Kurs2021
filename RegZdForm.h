...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->toolStripButtonAdd->Click += gcnew System::EventHandler(this, &RegZdForm::добавитьСтрокуToolStripMenuItem_Click);
			// 
			...
			this->toolStripButtonCorrect->Click += gcnew System::EventHandler(this, &RegZdForm::изменитьСтрокуToolStripMenuItem_Click);
			// 
			...
			this->toolStripButtonRequest->Click += gcnew System::EventHandler(this, &RegZdForm::найтиToolStripMenuItem_Click);
			// 
			// menuStrip1
			// 
			...
			this->добавитьСтрокуToolStripMenuItem->Click += gcnew System::EventHandler(this, &RegZdForm::добавитьСтрокуToolStripMenuItem_Click);
			// 
			...
			this->изменитьСтрокуToolStripMenuItem->Click += gcnew System::EventHandler(this, &RegZdForm::изменитьСтрокуToolStripMenuItem_Click);
			// 
			...
			this->найтиToolStripMenuItem->Click += gcnew System::EventHandler(this, &RegZdForm::найтиToolStripMenuItem_Click);
			// 
			...
			this->журналУчетаНомеровПКДToolStripMenuItem->Click += gcnew System::EventHandler(this, &RegZdForm::журналУчетаНомеровПКДToolStripMenuItem_Click);
			// 
			...
			this->журналУчетаВыполненнойПКДToolStripMenuItem->Click += gcnew System::EventHandler(this, &RegZdForm::журналУчетаВыполненнойПКДToolStripMenuItem_Click);
			// 
			...
			this->журналРегистрацииЗаданийToolStripMenuItem->Click += gcnew System::EventHandler(this, &RegZdForm::журналРегистрацииЗаданийToolStripMenuItem_Click);
			// 
			...
			this->справкаToolStripMenuItem->Click += gcnew System::EventHandler(this, &RegZdForm::справкаToolStripMenuItem_Click);
			// 
			// label1
			// 
