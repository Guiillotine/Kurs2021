...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label2->Location = System::Drawing::Point(495, 68);
			...
			this->dataGridView1->Location = System::Drawing::Point(44, 106);
			...
			this->toolStripButtonAdd->Click += gcnew System::EventHandler(this, &PKDForm::добавитьСтрокуToolStripMenuItem_Click);
			// 
			...
			this->toolStripButtonCorrect->Click += gcnew System::EventHandler(this, &PKDForm::изменитьСтрокуToolStripMenuItem_Click);
			// 
			...
			this->toolStripButtonRequest->Click += gcnew System::EventHandler(this, &PKDForm::найтиToolStripMenuItem_Click);
			// 
			// Column1
			// 
